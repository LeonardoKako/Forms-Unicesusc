...
// Importações dos mesmos componentes estruturais de visualização da ReviewPageEvent
import RequesterDetailsCard from "../ReviewPageEvent/components/RequesterDetailsCard";
import EventDetailsCard from "../ReviewPageEvent/components/EventDetailsCard";
import LocationAgendaCard from "../ReviewPageEvent/components/LocationAgendaCard";
import FoodFinanceCard from "../ReviewPageEvent/components/FoodFinanceCard";
