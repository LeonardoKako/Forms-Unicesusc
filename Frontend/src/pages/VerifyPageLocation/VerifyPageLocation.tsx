...
export default function VerifyPageLocation() {
  ...
  useEffect(() => {
    ...
    const verifyToken = async () => {
      try {
        // GET /locations/verify-author?token=TOKEN
        await api.get(`/locations/verify-author`, {
          params: { token },
        });
        setStatus("success");
      } catch (err: any) {
        ...
        const backendMessage =
          ...
          "Token de verificação inválido ou expirado (tempo limite excedido).";
        ...
        <div className='animate-scaleUp'>
          ...
          <div className='p-8 bg-emerald-600 text-white text-center flex flex-col items-center'>
            ...
            <p className='text-xs text-emerald-100/90 mt-1 font-medium'>
              A solicitação de locação foi verificada com sucesso
            </p>
          </div>
          ...
          <div className='p-8 sm:p-10 text-center space-y-6'>
            ...
            >
              A solicitação de locação externa foi confirmada e já foi
              encaminhada para a aprovação do administrador de locações.
            </p>
        ...
        <div className='animate-scaleUp'>
          ...
          <div className='p-8 bg-red-600 text-white text-center flex flex-col items-center'>
            ...
            <p className='text-xs text-red-100/90 mt-1 font-medium'>
              Não foi possível confirmar o agendamento da locação
            </p>
          </div>
          ...
          <div className='p-8 sm:p-10 text-center space-y-6'>
            <div className='bg-red-50/55 border border-red-100 rounded-2xl p-5 text-left'>
              ...
              <p className='text-xs sm:text-sm text-red-700 leading-relaxed font-medium'>
                {errorMessage ||
                  "Token de verificação inválido ou expirado. A solicitação de locação foi cancelada automaticamente. Por favor, solicite ao responsável o preenchimento do formulário novamente."}
              </p>
            </div>
